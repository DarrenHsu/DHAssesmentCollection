...
class DHAssesmentCollectionView: UIView {
    ...
    private lazy var leftHeader: DHHeaderCollectionView = {
        var leftHeader = DHHeaderCollectionView(frame: CGRect.zero, collectionViewLayout: DHCollectionViewFlowLayout.createHorizontalFlowLayout())
    ...
    private lazy var rightHeader: DHHeaderCollectionView = {
        let rightHeader = DHHeaderCollectionView(frame: .zero, collectionViewLayout: DHCollectionViewFlowLayout.createHorizontalFlowLayout())
