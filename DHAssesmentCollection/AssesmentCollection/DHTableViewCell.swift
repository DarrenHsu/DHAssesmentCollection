...
class DHTableViewCell: UITableViewCell {
    ...
    var collectionView: DHHeaderCollectionView!
    ...
    private func setupUI() {
        self.collectionView = DHHeaderCollectionView(frame: CGRect.zero, collectionViewLayout: DHCollectionViewFlowLayout.createHorizontalFlowLayout())
